...
var beet_scene_path = preload("res://scenes/objects/environment/crops/harvesting_beet.tscn")

@onready var beet_sprite: Sprite2D = $BeetSprite
...
func on_harvest() -> void:
	var crop_ready_harvest = beet_scene_path.instantiate() as Node2D
...
func _process(delta: float) -> void:
	...
	beet_sprite.frame = growing_state
