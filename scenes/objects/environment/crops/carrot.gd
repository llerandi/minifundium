...
var carrot_scene_path = preload("res://scenes/objects/environment/crops/harvesting_carrot.tscn")

@onready var carrot_sprite: Sprite2D = $CarrotSprite
...
func _process(delta: float) -> void:
	...
	carrot_sprite.frame = growing_state
